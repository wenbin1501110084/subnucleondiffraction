/*
 * Calculate GTMDs in momentum space
 * Calculate diffractive cross sections
 * wenbin Zhao<wenbinzhao237@gmail.com> 2024 - 2025
 */
#include "GTMDS.hpp"
#include <cmath>
#include <stdio.h>
...
std::vector<double> Diffraction::GTMDs_b_integrated(double xpom, double kt, double theta_kt)
{
